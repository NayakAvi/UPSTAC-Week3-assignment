...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        final User docter =userLoggedInService.getLoggedInUser();

        return testRequestQueryService.findByDoctor(docter);
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            testRequestUpdateService.assignForConsultation(id,docter);
            return testRequestQueryService.getTestRequestById(id).get();
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            testRequestUpdateService.updateConsultation(id,testResult,docter);
            return testRequestQueryService.getTestRequestById(id).get();
